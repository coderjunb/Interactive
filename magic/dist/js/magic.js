(function() {
    var
        ...
        duration = 1000,
        allDuration = duration * dom_cards.length,
        times = 10, // 拖动倍数
    ...
    dom_cards.forEach(function(dom, i) {
        ...
        dom.style.webkitAnimationDuration = allDuration + 'ms';
    ...
    dom_circle.addEventListener("touchmove", function(event) {
        ...
        dom_cards.forEach(function(dom, i) {
            ...
            delay = delay > 0 ? (delay % allDuration - allDuration) : delay;
            delay = delay < -allDuration ? (delay % allDuration) : delay;
    ...
    function touchend() {
        if (distance) {
            ...
            // if (delay_base > allDuration) {
            //     delay_base -= allDuration;
            // } else if (delay_base < -allDuration) {
            //     delay_base += allDuration;
            // }
            setTimeout(function() {
